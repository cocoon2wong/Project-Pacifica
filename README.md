<!--
 * @Author: Conghao Wong
 * @Date: 2024-11-05 15:26:56
 * @LastEditors: Conghao Wong
 * @LastEditTime: 2025-05-13 15:04:31
...
This is the development repo of the official PyTorch codes of paper "Resonance: Learning to Predict Social-Aware Pedestrian Trajectories as Co-Vibrations".
...
<details>
    <summary>
        <code>--interaction_type</code>
    </summary>
    <p>
        Choose the type of social-interaction-representation when training. It accepts an integer value: - <code>0</code>: Angle-based resonance pooling (default); - <code>1</code>: SocialCircle; - <code>2</code>: SocialPooling; - <code>3</code>: GCN.
    </p>
    <ul>
        <li>Type=<code>int</code>, argtype=<code>static</code>;</li><li>This arg can also be spelled as<code>--use_original_socialcircle</code>;</li>
        <li>The default value is <code>0</code>.</li>
    </ul>
</details>
