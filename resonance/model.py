...
from .__layers import SocialCircleLayer, SocialGCNLayer, SocialPoolingLayer
    ...
    *Re* Model
    ...
    def __init__(self, structure=None, *args, **kwargs):
        ...
        if s == 0:
            ...
            self.re_args._set('partitions', self.tr1.Tshape[0])
            self.rc = SocialGCNLayer(hidden_units=self.d,
                                     output_units=self.d,
                                     transform_layer=self.tr1)
        else:
